...
<input type="text" id="searchInput" placeholder="Search projects..." oninput="filterProjects()" style="width: 100%; padding: 10px; margin: 0px 0; font-size: 16px; color: #3e4a45;">
